...
var CountdownWebCrawlerService = (function(_StoreCrawlerServiceB) {
  ...
  function CountdownWebCrawlerService(context) {
    ...
    _this.syncTags = _asyncToGenerator(
    ...
    _this.updateStoreTags = _asyncToGenerator(
    ...
    _this.crawlLevelThreeProductCategories = (function() {
      var _ref6 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee6(productCategories) {
          var config, updatedProductCategories;
          return regeneratorRuntime.wrap(
    ...
    _this.crawlStoreTagsTotalItemsInfo = (function() {
      var _ref7 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee7(storeTags) {
    ...
    _this.crawlProductsForEachStoreTag = (function() {
      var _ref8 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee8(storeTags) {
          var config;
          return regeneratorRuntime.wrap(
    ...
    _this.crawlProductDetails = (function() {
      var _ref9 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee9(product, storeTags) {
          var config;
          return regeneratorRuntime.wrap(
                        ...
                        var crawler = new _crawler2.default({
                          ...
                          callback: function callback(error, res, done) {
                            ...
                            $('#content-container #content-panel #product-details').filter(function filterProductDetails() {
                              ...
                              var imageUrl =
                                config.get('baseUrl') +
                                productTagWrapperContainer.find('.big-image-container .product-image .product-image').attr('src');
                              ...
                              productDetailsBasicInfo.find('.cost-container .club-price-container').filter(function filterClubPriceDetails() {
                                ...
                                var nonClubPriceContent = $(this)
                                  ...
                                  .text()
                                  .trim();
                                var wasPrice = _2.StoreCrawlerServiceBase.removeDollarSignFromPrice(
                                  nonClubPriceContent.substring(nonClubPriceContent.indexOf('$')),
                                );
                                var unitPrice = self.getUnitPrice($(this));
                            ...
                            _this
                              .updateProductDetails(product, storeTags, productInfo)
                              .then(function() {
                                return done();
                              })
    ...
    _this.updateProductDetails = (function() {
      var _ref10 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee10(product, storeTags, originalProductInfo) {
          var storeId,
            productInfo,
            priceDetails,
            priceToDisplay,
                ...
                switch ((_context10.prev = _context10.next)) {
                  case 0:
                    ...
                    return _context10.abrupt(
                      'return',
                      Promise.all([
                        _this.createOrUpdateProductPrice(storeProductId, productPrice, priceDetails),
                        _this.updateExistingStoreProduct(
                          product.merge({
                            name: productInfo.get('name'),
                            description: productInfo.get('description'),
    ...
    _this.syncLevelOneTags = (function() {
      var _ref11 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee11(storeTags) {
    ...
    _this.syncLevelTwoTags = (function() {
      var _ref12 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee12(storeTags) {
    ...
    _this.syncLevelThreeTags = (function() {
      var _ref13 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee13(storeTags) {
