...
var Health2000WebCrawlerService = (function(_StoreCrawlerServiceB) {
  ...
  function Health2000WebCrawlerService(context) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Health2000WebCrawlerService.__proto__ || Object.getPrototypeOf(Health2000WebCrawlerService)).call(this, 'health2000', context),
    );
    ...
    _this.crawlProductsForEachStoreTag = (function() {
      var _ref2 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee2(storeTags) {
          var config;
          return regeneratorRuntime.wrap(
    ...
    _this.crawlProductDetails = (function() {
      var _ref3 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee3(product, storeTags) {
          var config;
          return regeneratorRuntime.wrap(
                              ...
                              productDetails.find('.productDetail .js-price').filter(function filterPrice() {
                                $(this)
                                  ...
                                  .filter(function filterWasPrice() {
                                    ...
                                    productInfo = productInfo.merge(
                                      (0, _immutable.Map)({
                                        wasPrice: _2.StoreCrawlerServiceBase.removeDollarSignFromPrice(
                                          priceStr.substring(priceStr.lastIndexOf(' ') + 1),
                                        ),
                                      }),
                                    );
                                ...
                                $(this)
                                  ...
                                  .filter(function filterIsPrice() {
                                    ...
                                    productInfo = productInfo.merge(
                                      (0, _immutable.Map)({
                                        currentPrice: _2.StoreCrawlerServiceBase.removeDollarSignFromPrice(
                                          priceStr.substring(priceStr.lastIndexOf(' ') + 1),
                                        ),
                                      }),
                                    );
    ...
    _this.updateProductDetails = (function() {
      var _ref4 = _asyncToGenerator(
        regeneratorRuntime.mark(function _callee4(product, storeTags, productInfo) {
                ...
                switch ((_context4.prev = _context4.next)) {
                  ...
                  case 2:
                    ...
                    return _context4.abrupt(
                      'return',
                      Promise.all([
                        _this.createOrUpdateProductPrice(storeProductId, productPrice),
