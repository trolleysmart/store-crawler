...
var _StoreCrawlerServiceBase = require('../StoreCrawlerServiceBase');

var _StoreCrawlerServiceBase2 = _interopRequireDefault(_StoreCrawlerServiceBase);
  ...
  function CountdownWebCrawlerService() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = CountdownWebCrawlerService.__proto__ || Object.getPrototypeOf(CountdownWebCrawlerService)).call.apply(_ref, [this].concat(args)),
      )),
      _this)),
              ...
              function _callee$(_context) {
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.next = 2;
                      return _this.createNewCrawlSessionAndGetConfig('Countdown Product Categories', config, 'Countdown', sessionToken);
                    ...
                    case 15:
                      ...
                      _context.next = 19;
                      return _trolleySmartParseServerCommon.CrawlResultService.create(crawlResult, null, sessionToken);
      ...
      (_this.updateProductDetails = (function() {
        var _ref7 = _asyncToGenerator(
          regeneratorRuntime.mark(function _callee6(product, storeTags, originalProductInfo, updatePriceDetails, storeName, sessionToken) {
            var masterProductId,
              storeId,
              productInfo,
              priceDetails,
...
})(_StoreCrawlerServiceBase2.default);
