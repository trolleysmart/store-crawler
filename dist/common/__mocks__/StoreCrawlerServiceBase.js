...
var StoreCrawlerServiceBase = function StoreCrawlerServiceBase() {
  ...
  this.getStoreTags = function () {
    var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(includeTag) {
  ...
  this.createOrUpdateLevelOneProductCategory = function () {
    var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(productCategory, storeTags) {
  ...
  this.createOrUpdateLevelTwoProductCategory = function () {
    var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(productCategory, storeTags) {
  ...
  this.createOrUpdateLevelThreeProductCategory = function () {
    var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(productCategory, storeTags) {
  ...
  this.logVerbose = _asyncToGenerator(regeneratorRuntime.mark(function _callee6() {
  ...
  this.logInfo = _asyncToGenerator(regeneratorRuntime.mark(function _callee7() {
  ...
  this.logError = _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
