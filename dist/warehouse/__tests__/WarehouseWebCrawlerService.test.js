...
describe('crawlProductCategories', function() {
  test(
    'should crawl product categories and save to database',
    _asyncToGenerator(
...
describe('syncProductCategoriesToStoreTags', function() {
  test(
    'should sync product categories that have already been crawled into store tags',
    _asyncToGenerator(
...
describe('crawlProducts', function() {
  test(
    'should crawl products and save to database',
    _asyncToGenerator(
...
describe('crawlProductsDetails', function() {
  test(
    'should crawl store master products details',
    _asyncToGenerator(
