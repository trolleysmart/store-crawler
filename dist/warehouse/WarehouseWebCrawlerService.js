...
var WarehouseWebCrawlerService = function (_StoreCrawlerServiceB) {
  ...
  function WarehouseWebCrawlerService(context) {
    ...
    _this.crawlAndSyncProductCategoriesToStoreTags = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    _this.crawlProducts = function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(config, sessionToken) {
    ...
    _this.crawlProductCategoriesTotalItemsInfo = function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(config, productCategories) {
    ...
    _this.crawlProductsDetails = function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(config, sessionToken) {
    ...
    _this.updateProductDetails = function () {
      var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(product, storeTags, productInfo, updatePriceDetails, storeName, sessionToken) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 16:
                ...
                _trolleySmartParseServerCommon.StoreMasterProductService.update(product.merge({
