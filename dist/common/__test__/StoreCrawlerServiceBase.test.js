...
var MicroBusinessParseServerCommon = require('@microbusiness/parse-server-common');
var TrolleySmartParseServerCommon = require('@trolleysmart/parse-server-common');
...
describe('getStore', function () {
  it('should create new store if provided store deos not exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
  ...
  it('should return the store info if provided store exist', _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
  ...
  it('should throw exception if multiple store found with the provided store name', _asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
