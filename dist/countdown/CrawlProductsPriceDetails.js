...
var jobName = 'Countdown - Crawl Products Price Details';

Parse.Cloud.job(
  jobName,
  (function() {
    var _ref = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee(request, status) {
            ...
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  service = new _CountdownWebCrawlerService2.default({
                  ...
                  _context.prev = 4;
                  _context.next = 7;
                  return service.crawlProductsPriceDetails();
