...
var StoreCrawlerServiceBase = function StoreCrawlerServiceBase(storeKey) {
              ...
              switch ((_context4.prev = _context4.next)) {
                ...
                case 2:
                  ...
                  result = new _trolleySmartParseServerCommon.StoreTagService().searchAll(
                    (0, _immutable.Map)({ include_tag: !!includeTag, conditions: (0, _immutable.Map)({ storeId: storeId }) }),
                    _this.sessionToken,
                  );
                  _context4.prev = 4;
  ...
  this.updateExistingStoreTag = (function() {
    var _ref7 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee5(storeTag) {
        return regeneratorRuntime.wrap(
  ...
  this.getTags = (function() {
    var _ref8 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee6(level) {
        var result, tags;
        return regeneratorRuntime.wrap(
          function _callee6$(_context6) {
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  result = new _trolleySmartParseServerCommon.TagService().searchAll(
                    (0, _immutable.Map)({ conditions: (0, _immutable.Map)({ level: level || undefined }) }),
                    _this.sessionToken,
                  );
                  _context6.prev = 1;
  ...
  this.createOrUpdateStoreProduct = (function() {
    var _ref9 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee7(productCategory, productInfo) {
  ...
  this.createOrUpdateLevelOneProductCategory = (function() {
    var _ref10 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee8(productCategory, storeTags) {
  ...
  this.getActiveProductPrices = (function() {
    var _ref19 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee14(storeProductId) {
  ...
  this.updateExistingStoreProduct = (function() {
    var _ref20 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee15(storeProduct) {
        return regeneratorRuntime.wrap(
  ...
  this.crawlProductsDetailsAndCurrentPrice = _asyncToGenerator(
  ...
  this.createNewTag = (function() {
    var _ref25 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee20(tagInfo) {
        return regeneratorRuntime.wrap(
  ...
  this.logInfo = (function() {
    var _ref27 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee22(messageFunc) {
        var config;
        return regeneratorRuntime.wrap(
  ...
  this.logError = (function() {
    var _ref28 = _asyncToGenerator(
      regeneratorRuntime.mark(function _callee23(messageFunc) {
        var config;
        return regeneratorRuntime.wrap(
  ...
  this.crawlProductDetails = _asyncToGenerator(
