...
var Health2000 = function (_StoreCrawlerServiceB) {
  _inherits(Health2000, _StoreCrawlerServiceB);

  function Health2000(context) {
    var _this2 = this;

    _classCallCheck(this, Health2000);

    var _this = _possibleConstructorReturn(this, (Health2000.__proto__ || Object.getPrototypeOf(Health2000)).call(this, 'health2000', context));
                ...
                return _context2.abrupt('return', new Promise(function (resolve) {
                  var crawler = new _crawler2.default({
                    ...
                    callback: function callback(error, res, done) {
                      ...
                      var url = _common.StoreCrawlerServiceBase.safeGetUri(res);
                      ...
                      $('#ProductDisplay .js-productDetail').filter(function filterProductDetails() {
                        ...
                        productDetails.find('.productDetail .js-price').filter(function filterPrice() {
                          $(this).find('.was').filter(function filterWasPrice() {
                            ...
                            productInfo = productInfo.merge((0, _immutable.Map)({ wasPrice: _common.StoreCrawlerServiceBase.removeDollarSignFromPrice(priceStr.substring(priceStr.lastIndexOf(' ') + 1)) }));
                          ...
                          $(this).find('.is').filter(function filterIsPrice() {
                            ...
                            productInfo = productInfo.merge((0, _immutable.Map)({ currentPrice: _common.StoreCrawlerServiceBase.removeDollarSignFromPrice(priceStr.substring(priceStr.lastIndexOf(' ') + 1)) }));
                            return 0;
                          });
