...
var CountdownWebCrawlerService = (function(_ServiceBase) {
  ...
  function CountdownWebCrawlerService() {
    ...
    return (_ret = (
      ...
      (_this.syncProductCategoriesToStoreTags = _asyncToGenerator(
        ...
        return new Promise(function(resolve, reject) {
          var crawler = new _crawler2.default({
            ...
            callback: function callback(error, res, done) {
              ...
              Promise.all(
                productInfos.map(function(productInfo) {
                ...
                while (1) {
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 21:
                      ...
                      errorMessage =
                        _context4.t0 instanceof _microBusinessParseServerCommon.Exception ? _context4.t0.getErrorMessage() : _context4.t0;
                      _updatedSessionInfo2 = sessionInfo.merge(
                        (0, _immutable.Map)({
                          endDateTime: new Date(),
                          additionalInfo: (0, _immutable.Map)({
                            status: 'failed',
          ...
          var crawler = new _crawler2.default({
            ...
            callback: function callback(error, res, done) {
              ...
              $('#breadcrumb-panel .breadcrumbs').children().last().filter(function filterProductTags() {
                var tags = _immutable2.default
                  .fromJS($(this).attr('href').split('/'))
                  .map(function(_) {
                    return _.trim();
                  })
              ...
              $('#content-container #content-panel #product-details').filter(function filterProductDetails() {
                ...
                var imageUrl = productTagWrapperContainer.find('.big-image-container .product-image .product-image').attr('src');
                ...
                _smartGroceryParseServerCommon.CrawlResultService
                  .create(crawlResult)
                  .then(function() {
                    return done();
                  })
