    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            expect(createNewStoreCrawlerServiceBase().createNewCrawlSession((0, _v2.default)())).resolves.toEqual(crawlSessionInfos.first());
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            expect(createNewStoreCrawlerServiceBase().getMostRecentCrawlSessionInfo((0, _v2.default)())).resolves.toEqual(crawlSessionInfos.first());
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            expect(createNewStoreCrawlerServiceBase().getMostRecentCrawlSessionInfo((0, _v2.default)())).rejects.toBeDefined();
